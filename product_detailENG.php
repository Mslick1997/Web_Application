  ...
  <div class="container">
    ...
    ">
      ...
      <div class="col-md-5"> <br><br><br>
        ...
        ID: <?=$row['id']?> <br>
        Detail : <?=$row['detail']?> <br><br>
        <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
          <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off">
          <label class="btn btn-outline-success" for="btnradio1">No sugar</label>

          <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off">
          <label class="btn btn-outline-success" for="btnradio2">Less sweet</label>

          <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off" checked>
          <label class="btn btn-outline-success" for="btnradio3">Normal sweet</label>
        
          <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off">
          <label class="btn btn-outline-success" for="btnradio4">Very sweet</label>

          <input type="radio" class="btn-check" name="btnradio" id="btnradio5" autocomplete="off">
          <label class="btn btn-outline-success" for="btnradio5">Extremely sweet</label>
        ...
        <div class="form-check form-switch mt-3">
          ...
          <label style="font-size: 22px; color: #808080;" class="form-check-label" for="flexSwitchCheckDefault">&nbsp;&nbsp;Tapioca pearls</label>
        </div>
        <h2 class="text-danger mt-3">฿<?=$row['price']?><br>
        <a class="btn btn-outline-success mt-3" href="orderENG.php?id=<?=$row['id']?>" style="font-size: 20px;">Add To Cart</a>
      </div>
    </div>
    <br><br>
  </div>
