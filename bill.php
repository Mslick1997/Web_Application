        ...
        <div class="col-md-10">
            <div class="alert alert-success h4 text-center mt-5" role="alert">
                ...
                <div class="card mb-4 mt-4">
                    ...
                    <h6 class="text-end">รวมเป็นเงิน <b class="text-danger"><?=number_format($total_price, 2)?></b> บาท</h6>
                </div>
            </div>
            <div class="text-danger" style="font-weight: bold;">
                *** กรุณาชำระเงินภายใน 7 วัน หลังจากทำการสั่งซื้อ ***
            </div>
