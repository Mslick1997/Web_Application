                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="alert alert-dark h4" role="alert">
                            ...
                            <div class="card-body">
                                ชื่อ-นามสกุล:
                            <input type="text" name="cus_name" class="form-control mt-1 mb-3" placeholder="ชื่อ-นามสกุล ...">
                                ที่อยู่จัดส่งสินค้า:
                            <textarea class="form-control mt-1 mb-3" placeholder="ที่อยู่ ..." name="cus_add" rews="3"></textarea>
                                เบอร์โทรศัพท์:
                            <input type="number" name="cus_tel" class="form-control mt-1 mb-3" placeholder="เบอร์โทรศัพท์ ...">
                        </div>
                    </div>
                    <br><br><br>
                </div>
